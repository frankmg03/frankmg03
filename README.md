...
💻 Estudiante de último semestre en Ingeniería en Desarrollo de Software.  
...
- Desarrollo colaborativo usando Python y PostgreSQL
- CRUD completo de productos
- API REST

🔹 **Sistema Inmobiliario Web**
- Frontend con Vue.js
- Integración con APIs REST
- Gestión de propiedades

🔹 **Página Web Informativa (Cliente USA)**
- Proyecto freelance internacional
- Desarrollo web responsive
- Trabajo remoto en equipo
...
⚙️ Buenas prácticas de desarrollo seguro
